...
<div class="col-md-4 box-info ">
        <h2 class="Main-text-header">Over ons</h2></br>
        <p class="textfield_Style"><?php echo get_theme_mod('bl-Information-text')?></p>
      </div>

      <div class="col-lg-2 col-md-5 mb-1 mb-lg-0">
        <img
          src="<?php echo wp_get_attachment_url(get_theme_mod('bl-info-image'))?>"
          class="w-100 shadow-1-strong rounded mb-4"
        />

        <img
          src="<?php echo wp_get_attachment_url(get_theme_mod('bl-info-image3'))?>"
          class="w-100 shadow-1-strong rounded mb-4"
        />
      </div>
      ...
      <div class="col-lg-2 mb-4 mb-lg-0">
        <img
          src="<?php echo wp_get_attachment_url(get_theme_mod('bl-info-image2'))?>"
          class="w-100 shadow-1-strong rounded mb-4"
        />
      </div>
    </div>
